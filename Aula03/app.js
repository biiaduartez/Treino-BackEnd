/*********************************************************
  Objetivo: Criar um app  com entrada de 02 valores e realize as quatro operações matemáticas
 * Data: 30/01/2023
...
entradaDados.question(
    'Digite o NÚMERO de acordo com a operação:\n1-SOMA\n2-SUBTRAÇÃO\n3-MULTIPLICAÇÃO\n4-DIVISÃO: \nESCOLHA: ',
    function(tipo) {
        ...
        } else if (Number(tipoOperacao) !=
            1 && Number(tipoOperacao) != 2 && Number(tipoOperacao) !=
            3 && Number(tipoOperacao) != 4) {
